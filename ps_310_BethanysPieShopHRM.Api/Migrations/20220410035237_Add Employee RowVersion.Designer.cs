...
namespace ps_310_BethanysPieShopHRM.Api.Migrations
{
    ...
    [Migration("20220410035237_Add Employee RowVersion")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ps_310_BethanysPieShopHRM.Shared.Country", b =>
                {
            ...
            modelBuilder.Entity("ps_310_BethanysPieShopHRM.Shared.Employee", b =>
                {
            ...
            modelBuilder.Entity("ps_310_BethanysPieShopHRM.Shared.JobCategory", b =>
                {
                    b.Property<int>("JobCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ps_310_BethanysPieShopHRM.Shared.Employee", b =>
                {
                    b.HasOne("ps_310_BethanysPieShopHRM.Shared.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ps_310_BethanysPieShopHRM.Shared.JobCategory", "JobCategory")
                        .WithMany()
